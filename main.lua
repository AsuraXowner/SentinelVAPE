...
getgenv().VapeLoaded = getgenv().VapeLoaded or false
getgenv().VapeGameLoaded = getgenv().VapeGameLoaded or false
...
if not shared.VapeIndependent then
    ...
    if game.PlaceId == 286090429 then
		loadstring(game:HttpGet("https://raw.githubusercontent.com/AsuraXowner/SentinelVAPE/refs/heads/main/games/Arsenal.lua"))()
	elseif game.PlaceId == 17625359962 or game.PlaceId==117398147513099 then
		loadstring(game:HttpGet("https://raw.githubusercontent.com/AsuraXowner/SentinelVAPE/refs/heads/main/games/Rivals.lua"))()
	elseif game.PlaceId == 301549746 or game.PlaceId == 1480424328 or game.PlaceId == 1869597719 then
		loadstring(game:HttpGet("https://raw.githubusercontent.com/AsuraXowner/SentinelVAPE/refs/heads/main/games/CounterBlox.lua"))()
	else
	...
	task.spawn(function()
        ...
        repeat task.wait() until getgenv().VapeGameLoaded == true
		finishLoading()
	end)
